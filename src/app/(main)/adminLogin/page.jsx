        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
          <Form className='space-y-5'>
            ...
            <div className='relative'>
              ...
              <Field name='adminId' type='text' placeholder='Admin ID' className='pl-10 pr-4 py-2 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500' />
            ...
            {/* Submit Button */}
            <button type='submit' className='w-full py-2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white font-semibold rounded-lg hover:scale-105 transition'>
              Login as Admin
            </button>
          </Form>
        </Formik>
